...
Este pacote permite a coleta de dados de proposições legislativas da Assembleia Legislativa do Mato Grosso do Sul (ALMS) acessando a API do SGPL.
...
Após instalar o pacote, você pode utilizar a função `coleta_proposicoes_legislativa_ALMS` para coletar os dados. Aqui está um exemplo de como utilizar a função
